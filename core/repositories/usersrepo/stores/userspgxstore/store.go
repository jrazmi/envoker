...
// Store provides database access for User.
...
//
// func (s *Store) GetActiveUserRecords(ctx context.Context) ([]usersrepo.User, error) {
//     query := `SELECT * FROM public.users WHERE status = 'active' ORDER BY created_at DESC`
//
