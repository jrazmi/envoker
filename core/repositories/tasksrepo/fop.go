...
//
// From:  type TaskFilter = GeneratedTaskFilter
// To:    type TaskFilter struct {
//            GeneratedTaskFilter
...
// This is a type alias to GeneratedTaskFilter for zero-cost abstraction.
// Change to struct embedding if you need to add custom filter fields.
type TaskFilter = GeneratedTaskFilter
