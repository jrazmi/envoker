...
//
// From:  type SchemaMigrationFilter = GeneratedSchemaMigrationFilter
// To:    type SchemaMigrationFilter struct {
//            GeneratedSchemaMigrationFilter
...
// This is a type alias to GeneratedSchemaMigrationFilter for zero-cost abstraction.
// Change to struct embedding if you need to add custom filter fields.
type SchemaMigrationFilter = GeneratedSchemaMigrationFilter
